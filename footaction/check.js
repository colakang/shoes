...
function goLogin (thecasper,aPid,uName,fs,loop) {
	...
	thecasper.thenOpen('https://m.footaction.com/?uri=account', function(response) {
...
function goCart(thecasper,newurl) {
	...
	thecasper.thenOpen('https://m.footaction.com/?uri=cart', function(response) {
		while (true) {
...
casper.start().then(function() {
	...
	//casper.exit();
	//goCart(this,"https://m.footaction.com/?uri=checkout");
	//doCheckOut(this,"https://m.footaction.com/?uri=checkout");
});
...
casper.run(function() { 
	...
	//fs.write('/root/nike/footaction/cookies.txt', cookies, 'w'); 
